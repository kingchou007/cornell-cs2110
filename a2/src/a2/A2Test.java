...
public class A2Test {
    ...
    public static void testStudentSize() {
        StudentList list = new StudentList();
    ...
    public static void testStudentGet() {
        StudentList list = new StudentList();
        Student s = new Student("Kane", "Li", 3);
        Student s1 = new Student("Jim", "Chou", 1);
        list.append(s);
        list.append(s1);
        System.out.println("list.get(1) = " + list.get(list.size() - 1));
        System.out.println("expected = JimChou");
    }
    ...
    public static void testGetProfName() {
    ...
    public static void testGetLectureTime() {
        ...
        System.out.println("c1.getLectureTime = " + c2.getLectureTime());
        System.out.println("expected = 12: 12 PM");
        System.out.println("c1.getLectureTime = " + c3.getLectureTime());
    ...
    public static void testEnrollStudent() {
        ...
        System.out.println("c.enrollStudent = " + c1.enrollStudent(s));
        System.out.println("expected = true");
    ...
    public static void testGetStudent() {
        ...
        c1.enrollStudent(s);
        c1.enrollStudent(s1);
        System.out.println("c.getStudent = " + c1.getStudents());
        System.out.println("expected = " + "KaneLiBillNye");
    ...
    public static void testDropStudent() {
        ...
        System.out.println("c.dropStudent = " + c1.dropStudent(s));
